...
//   focusOnSelect: true
// });
// $('.slider-nav-0').on('afterChange', function (event, slick, currentSlide, nextSlide) {
//   activeButton();
// });
//
// function activeButton() {
//   var itemRadioButton = document.querySelectorAll('.itemRadioButton');
//   for (let i = 0; i < itemRadioButton.length; i++) {
//     if (itemRadioButton[i].classList.contains('slick-current')) {
//       // console.log(i)
//       var radios = itemRadioButton[i].querySelector('.product-radio');
//       radios.checked = true;
//       // console.log(itemRadioButton[i].querySelector('.product-radio').value)
//     }
//   }
// }
...
$('.sl_2').slick({
  infinite: true,
  dots: true,
  prevArrow: $('.arrow-sl_left_2'),
  nextArrow: $('.arrow-sl_right_2'),
  arrows: true,
  adaptiveHeight: true,
  autoplay: true,
  autoplaySpeed: 3000
...
document.getElementById('burger1').addEventListener('change', function () {
  if (this.checked) {
...
//   },
// });
// $('.slider-nav-1').on('afterChange', function (event, slick, currentSlide, nextSlide) {
//   activeButton_1();
// });
//
// function activeButton_1() {
//   var itemRadioButton_1 = document.querySelectorAll('.itemRadioButton_1');
//   for (let i = 0; i < itemRadioButton_1.length; i++) {
//     if (itemRadioButton_1[i].classList.contains('slick-current')) {
//       // console.log(i)
//       var radios = itemRadioButton_1[i].querySelector('.product-radio');
//       radios.checked = true;
//       // console.log(itemRadioButton_1[i].querySelector('.product-radio').value)
//     }
//   }
// }
