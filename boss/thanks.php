<?php //***************** Страница с завершением заказа ******************
session_start();
...
// параметры запроса
$data = array(
	 'key'             => '0dc1ed92880fda8908832d6167a16d92', //Ваш секретный токен
	 ...
	 'additional_1'    => $_REQUEST['product'],                               // Дополнительное поле 1
	 'additional_2'    => $_REQUEST['size'],                               // Дополнительное поле 2
	 'additional_3'    => $_REQUEST['form'],                               // Дополнительное поле 3
	 'additional_4'    => ''                                // Дополнительное поле 4
);

// запрос
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'http://arol.lp-crm.biz/api/addNewOrder.html');
...
<div class="wrapper">
	<div class="unit unit_thanks">
		<div class="wr wr_thanks">
			<h1 class="title">Спасибо!</h1>
			<p class="text">Наши менеджеры свяжутся в ближайшее время</p>
